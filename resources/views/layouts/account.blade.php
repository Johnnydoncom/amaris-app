                ...
                <div class="container no-padding my-4 sm:min-h-full">
                    <div class="grid grid-cols-1 sm:grid-cols-4">
                        <div class="hiddenn sm:block sidebar border-r bg-clip-padding h-full sm:rounded-l-3xl bg-white overflow-hidden bg-primary text-white">
                            <ul class="menu flex overflow-x-auto gap-4 sm:gap-2 sm:py-4 sm:flex-col">
                                <li class="hover-bordered hover:bg-primary-600 hover:border-l-2 hover:border-secondary m-2 sm:m-0"><a href="{{ route('account.index') }}" class="flex whitespace-nowrap sm:whitespace-normal justify-between sm:py-2 sm:px-6 @if(request()->routeIs('account.index')) active text-white @endif">Home <svg class="w-4 h-4 hidden sm:block" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg></a></li>
                                <li class="hover-bordered hover:bg-primary-600 hover:border-l-2 hover:border-secondary m-2 sm:m-0"><a href="{{ route('account.order.index') }}" class="flex whitespace-nowrap sm:whitespace-normal justify-between sm:py-2 sm:px-6 @if(request()->routeIs('account.order.index')) active text-white @endif">Orders <svg class="w-4 h-4 hidden sm:block" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg></a></li>
                                @if(!Auth::user()->verified)
                                <li class="hover-bordered hover:bg-primary-600 hover:border-l-2 hover:border-secondary m-2 sm:m-0"><a href="{{ route('account.verification.index') }}" class="flex whitespace-nowrap sm:whitespace-normal justify-between px-4 rounded-xl sm:rounded-none border sm:border-none sm:py-2 sm:px-6 @if(request()->routeIs('account.verification.index')) active text-white @endif">Verification <svg class="w-4 h-4 hidden sm:block" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg></a></li>
                                @endif
                                <li class="hover-bordered hover:bg-primary-600 hover:border-l-2 hover:border-secondary m-2 sm:m-0"><a href="{{ route('account.password.index') }}" class="flex whitespace-nowrap sm:whitespace-normal justify-between sm:py-2 sm:px-6 @if(request()->routeIs('account.password.index')) active text-white @endif">Change Password <svg class="w-4 h-4 hidden sm:block" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg></a></li>
                                <li class="hover-bordered hover:bg-primary-600 hover:border-l-2 hover:border-secondary m-2 sm:m-0">
                                    <form method="POST" action="{{ route('logout') }}" class="w-full">
                                        @csrf
                                        <button class="flex whitespace-nowrap sm:whitespace-normal justify-between sm:p-4 sm:px-6 w-full" onclick="event.preventDefault(); this.closest('form').submit();">
