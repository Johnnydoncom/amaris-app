<x-app-layout>
    ...
    <div class="relative flex flex-col justify-center w-full bg-white py-6">
        <div class="mx-auto max-w-4xl rounded-none sm:rounded-3xl bg-secondary p-4 sm:p-20 py-6 sm:py-12 text-center">
