<header class="js-page-header top-0 z-50 w-full backdrop-blur shadow-md bg-white dark:bg-gray-800 transition-colors" :class="{'h-full fixed':menuOpened, 'sticky': !menuOpened}">
    <div class="flex items-center px-6 py-2 container">
        ...
        <nav class="navbar w-full ml-12 hidden sm:flex">
            <ul class="flex flex-col lg:flex-row">
                ...
                <li class="js-nav-dropdown nav-item dropdown group relative">
                    <a href="#" class="dropdown-toggle text-primary font-display font-semibold hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5"
                       id="navDropdown-3" aria-expanded="false" role="button" data-bs-toggle="dropdown">Product & Services
                        <i class="lg:hidden">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                    ...
                    >
                      ...
                      <span class="mr-3 rounded-xl bg-[#FDF7EE] p-[0.375rem]">
                        ...
                        <li>
                            <a href="collections.html" class="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center rounded-xl px-5 py-2 transition-colors">
        ...
        <div class="js-mobile-menu dark:bg-jacarta-800 invisible fixed inset-0 z-10 ml-auto items-center bg-white opacity-0 lg:visible lg:relative lg:inset-auto lg:flex lg:bg-transparent lg:opacity-100 dark:lg:bg-transparent w-full lg:justify-end" :class="{'nav-menu--is-open': menuOpened}" x-transition>
            ...
            <nav class="navbar w-full lg:hidden">
                <ul class="flex flex-col lg:flex-row">
                    ...
                    <li class="js-nav-dropdown nav-item dropdown group relative">
                        <a href="#"
                           class="dropdown-toggle text-primary font-display font-semibold hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5"
                           id="navDropdown-3" aria-expanded="false" role="button" data-bs-toggle="dropdown">Product & Services
                            <i class="lg:hidden">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="mt-10 w-full lg:hidden">
                <a href="#" class="js-wallet bg-accent shadow-accent-volume hover:bg-accent-dark block w-full rounded-full py-3 px-8 text-center font-semibold text-white transition-all" data-bs-toggle="modal" data-bs-target="#walletModal">
                    Connect Wallet
                </a>
            ...
            <div class="ml-8 hidden lg:flex xl:ml-12 gap-4 items-center">
                ...
                <!-- Dark Mode Switcher-->
                <a href="#" class="border-jacarta-100 hover:bg-accent focus:bg-accent group dark:hover:bg-accent js-dark-mode-trigger ml-2 flex h-10 w-10 items-center justify-center rounded-full border bg-white transition-colors hover:border-transparent focus:border-transparent dark:border-transparent dark:bg-white/[.15]" id="theme-toggle">
        ...
        <div class="ml-auto flex lg:hidden">
            <!-- Profile -->
            <a href="/"
                class="border-jacarta-100 hover:bg-accent focus:bg-accent group dark:hover:bg-accent ml-2 flex h-10 w-10 items-center justify-center rounded-full border bg-white transition-colors hover:border-transparent focus:border-transparent dark:border-transparent dark:bg-white/[.15]" aria-label="profile">
                <svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    width="24"
                    height="24"
