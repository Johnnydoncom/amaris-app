...
{{--                       </li>--}}
       ...
       <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">&copy; {{ date('Y') }} <a href="{{url('/')}}" class="hover:underline"> {{ setting('site_name') }}</a>. All Rights Reserved.
</span>
